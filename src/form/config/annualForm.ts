export function AnnualReportForm(id: string) {
    const form = `
      <!DOCTYPE html>
  <html lang="en">
  <head>
  ...
  <body>
      <div class="container">
          ...
          <strong><a href="http://localhost:3000/forms/annual/${id}/submit">http://localhost:3000/forms/annual/${id}/submit</a></strong>
